...
export const CRAWL_RULES: RuleSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '持续扩展', text: '独立 App Store Catalog Discovery 工作流每天运行一次，在 CN/HK/TW/MY/SG/US/JP 商店间轮换；读取免费榜、付费榜并轮换8个搜索词，每个搜索词最多200条。类别词、中文常用字符和英文字母组合会跨天推进，按 Bundle ID 与版本去重，持续增加实验目录而不随机枚举 Apple ID' },
