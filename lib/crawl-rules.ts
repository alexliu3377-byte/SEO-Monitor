...
export const CRAWL_RULES: RuleSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '自动识别', text: 'App Store 可直接从所选地区的免费榜或付费榜自动补全前100名，也可按已知链接或数字 ID 一次导入最多100个应用；Apple 官方公开接口会返回名称、Bundle ID、当前版本、更新日志、发布日期和包大小。普通网页优先读取来源配置的 CSS 选择器，其次读取 meta、JSON-LD、常见“更新日志/版本说明”标题和保守的版本号规则。所有新记录先进入“待审核”，不会直接成为正式最新版本' },
