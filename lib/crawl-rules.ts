...
export const CRAWL_RULES: RuleSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '自己站点排除', text: '同一个 has_rank_title 开关不区分"自己的站点"和竞品——如果自己的站点也开了排名追踪，会被当成竞品统计进 competitor_tracking_records。2026-08-10 起用 sites.is_own_site 字段判断（新增列，默认 false=竞品，用户在研究中心"管理竞品站点"弹窗里逐站手动标"自家/竞品"；上线时把当时已知的自己站点从 task_groups.site_domains 回填过一次，之后这两套机制脱钩，is_own_site 是唯一权威来源）。lib/tracking-summary.ts 的 fetchOwnSiteDomains() 读这个字段，竞品成效计算 + 研究中心"竞品成效"tab 的站点列表 + "管理竞品站点"弹窗都用它判断' },
