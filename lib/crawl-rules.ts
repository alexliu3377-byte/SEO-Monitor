...
export const CRAWL_RULES: RuleSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '持续扩展', text: '独立 App Store Catalog Discovery 工作流每天运行一次，在 CN/HK/TW/MY/SG/US/JP 商店间轮换；读取免费榜、付费榜并轮换12个搜索词，每个搜索词最多200条。默认一半搜索普通应用，一半搜索游戏；游戏覆盖角色扮演、策略、卡牌、射击、模拟经营、休闲、动作、冒险和生存等类别，也可手动只扩展游戏。系统按 Bundle ID 与版本去重，持续增加实验目录而不随机枚举 Apple ID' },
